...
import { submitLogin, continueWithGoogle } from '../actions'
        ...
        <>
            {(isLoading || isGoogleLoading) && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-sm animate-in fade-in duration-200">
                    <div className="flex flex-col items-center gap-4 bg-card p-8 rounded-3xl shadow-2xl border border-border animate-in zoom-in-95">
                        <Loader2 className="w-10 h-10 animate-spin text-primary" />
                        <p className="text-base font-bold text-foreground">{isGoogleLoading ? "Connecting to Google..." : "Signing you in..."}</p>
                    </div>
                </div>
            )}
            <div className="w-full max-w-[420px] bg-card border border-border rounded-2xl p-8 sm:p-10 shadow-xl mx-auto flex flex-col justify-center animate-in fade-in slide-in-from-bottom-4 duration-500 relative z-10">
                <div className="mb-8">
                ...
                <div className="mt-8 text-center text-sm text-muted-foreground">
                    ...
                    <Link href="/signup" className="text-primary hover:text-primary/80 font-medium font-semibold">
                        Create account
                    </Link>
                </div>
            </div>
