...
import { Plus, GripVertical, Trash2, Edit2, MessageSquare } from "lucide-react";
...
const initialQuestions = [
    {
        id: "1",
        question: "How was the quality of our food?",
        type: "Rating (1-5)",
        required: true,
    },
    {
        id: "2",
        question: "How was our staff's behaviour?",
...
export default function QuestionsBuilderPage() {
    ...
    return (
        <div className="space-y-6 max-w-4xl">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <CardDescription className="mt-1">
                                        Type: <span className="font-medium text-foreground">{q.type}</span>
                                        {" • "}
                                        {q.required ? (
            ...
            <div className="flex justify-end pt-4">
                <Button size="lg">Save Form Layout</Button>
            </div>
        </div>
    );
}
