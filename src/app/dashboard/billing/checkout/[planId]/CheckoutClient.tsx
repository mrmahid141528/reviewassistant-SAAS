...
export default function CheckoutClient({ plan, cycle, businessId, businessName, billingConfig }: any) {
                    ...
                    <div className="bg-card border rounded-2xl p-6 shadow-sm mt-4">
                        ...
                        <div className="space-y-4 text-sm mb-8">
                            ...
                            <div className="flex justify-between">
                                ...
                                <span className="font-medium">{plan.name} <span className="bg-primary/10 text-primary px-2 py-0.5 rounded-full text-[10px] uppercase tracking-wider ml-1">{cycle}</span></span>
                            </div>
                        </div>
