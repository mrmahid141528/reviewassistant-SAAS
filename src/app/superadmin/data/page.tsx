            ...
            <div className="grid lg:grid-cols-3 gap-6">
                    ...
                    <CardContent className="p-6">
                        <div className="grid grid-cols-2 gap-4 mb-6">
                            <div className="p-4 rounded-lg bg-slate-50 border border-slate-100 flex flex-col justify-center">
                                ...
                                <p className="text-2xl font-bold text-slate-900 mt-1 flex items-end gap-1">14.2 <span className="text-sm font-medium text-slate-500 mb-1">GB</span></p>
                            </div>
                            <div className="p-4 rounded-lg bg-slate-50 border border-slate-100 flex flex-col justify-center">
                                <p className="text-xs font-semibold text-slate-500 uppercase tracking-wide">Query Latency</p>
                                <p className="text-2xl font-bold text-emerald-600 mt-1 flex items-end gap-1">24 <span className="text-sm font-medium text-emerald-600/70 mb-1">ms avg</span></p>
                            </div>
                        </div>

                        <div className="space-y-3">
                            <div className="flex justify-between items-center text-sm">
                                <span className="text-slate-600 font-medium">Active Prisma Connections</span>
                                <span className="text-slate-900 font-bold">12 / 100 max</span>
                            </div>
                            ...
                            <div className="flex justify-between items-center text-sm pt-2">
                                <span className="text-slate-600 font-medium">Database CPU Load</span>
                ...
                <Card className="shadow-sm border-slate-200">
                    ...
                    <CardContent className="p-6 space-y-4">
                        <Button className="w-full justify-start gap-3 h-12 bg-slate-900 rounded-lg hover:bg-slate-800">
                            <Download className="h-4 w-4 text-emerald-400" />
                            <div className="text-left">
                                <div className="font-semibold text-sm text-white">Full Postgres Dump Export</div>
                                <div className="text-[10px] text-slate-400">Download complete schema & data.</div>
                            </div>
                        </Button>
                        <Button variant="outline" className="w-full justify-start gap-3 h-12 rounded-lg border-slate-200">
                            <DatabaseZap className="h-4 w-4 text-blue-500" />
                            <div className="text-left">
                                <div className="font-semibold text-sm text-slate-900">Trigger Manual Backup</div>
                                <div className="text-[10px] text-slate-500">Force an instantaneous snapshot.</div>
                            </div>
                        </Button>
                    </CardContent>
                </Card>
            ...
            <Card className="border-rose-200 shadow-sm">
                ...
                <CardContent className="p-6 bg-white space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between p-4 border border-rose-100 rounded-xl bg-rose-50/50">
                        ...
                        <Button variant="destructive" className="bg-rose-600 hover:bg-rose-700 text-white shadow-xl">
                            Factory Reset SaaS
                        </Button>
                    </div>
                </CardContent>
